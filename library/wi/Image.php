 ...
 * @copyright 2007-2011
  ...
  **/
	 ...
	 * @package Exceptions
	 */
	class wi_WideImage_InvalidImageDimensionException extends wi_WideImage_Exception {}
	 ...
	 * @package Exceptions
	 */
	class wi_WideImage_UnknownErrorWhileMappingException extends wi_WideImage_Exception {}
	 ...
	 * @package wi_WideImage
	 */
	abstract class wi_WideImage_Image
	{
		/**
		...
		/**
		 * Flag that determines if wi_WideImage should call imagedestroy() upon object destruction
		 * @var bool
		 */
		...
		{
			wi_WideImage::assertValidImageHandle($handle);
			$this->handle = $handle;
		}
		 ...
		 * Cleanup
		 * 
		 * Destroys the handle via wi_WideImage_Image::destroy() when called by the GC.
		 */
		function __destruct()
		{
			$this->destroy();
		...
		function isValid()
		{
			return wi_WideImage::isValidImageHandle($this->handle);
		}
		...
		{
			$mapper = wi_WideImage_MapperFactory::selectMapper($uri, null);
			$args = func_get_args();
			array_unshift($args, $this->getHandle());
			$res = call_user_func_array(array($mapper, 'save'), $args);
			if (!$res)
				throw new wi_WideImage_UnknownErrorWhileMappingException(get_class($mapper) . " returned an invalid result while saving to $uri");
		}
		
		/**
		 * Returns binary string with image data in format specified by $format
		 * 
		 * Additional parameters may be passed to the function. See wi_WideImage_Image::saveToFile() for more details.
		 * 
		...
		function asString($format)
		{
			...
			$mapper = wi_WideImage_MapperFactory::selectMapper(null, $format);
			$res = call_user_func_array(array($mapper, 'save'), $args);
			if (!$res)
				throw new wi_WideImage_UnknownErrorWhileMappingException(get_class($mapper) . " returned an invalid result while writing the image data");
		 ...
		 * Example:
		 * <code>
		 * wi_WideImage::load('image1.png')->resize(100, 100)->output('gif');
		 * </code>
		 * 
		...
		function output($format)
		{
			...
			$this->writeHeader('Content-type', wi_WideImage_MapperFactory::mimeType($format));
			echo $data;
		}
		...
		{
			return wi_WideImage_OperationFactory::get($name);
		}
		 ...
		 * 
		 * @return wi_WideImage_Image An image mask
		 **/
		function getMask()
		{
		 ...
		 * @return wi_WideImage_Image The resized image
		 */
		...
		/**
		 * Same as wi_WideImage_Image::resize(), but the image is only applied if it is larger then the given dimensions.
		 ...
		 * @param string $fit 'inside', 'outside', 'fill'
		 * @return wi_WideImage_Image resized image
		 */
		...
		/**
		 * Same as wi_WideImage_Image::resize(), but the image is only applied if it is smaller then the given dimensions.
		 * Otherwise, the resulting image retains the source's dimensions.
		 * 
		 * @param int $width New width, smart coordinate
		 * @param int $height New height, smart coordinate
		 ...
		 * @return wi_WideImage_Image The rotated image
		 */
		 ...
		 * <code>
		 * $watermark = wi_WideImage::load('logo.gif');
		 * $base = wi_WideImage::load('picture.jpg');
		 * $result = $base->merge($watermark, "right - 10", "bottom - 10", 50);
		 * // applies a logo aligned to bottom-right corner with a 10 pixel margin
		 * </code>
		 * 
		 * @param wi_WideImage_Image $overlay The overlay image
		 ...
		 * @return wi_WideImage_Image The merged image
		 */
		 ...
		 * <code>
		 * $image = wi_WideImage::load('someimage.jpg'); // 100x150
		 ...
		 * @return wi_WideImage_Image The resulting image with resized canvas
		 */
		 ...
		 * wi_WideImage::SIDE_TOP_LEFT, wi_WideImage::SIDE_TOP,
		 * wi_WideImage::SIDE_TOP_RIGHT, wi_WideImage::SIDE_RIGHT,
		 * wi_WideImage::SIDE_BOTTOM_RIGHT, wi_WideImage::SIDE_BOTTOM, 
		 * wi_WideImage::SIDE_BOTTOM_LEFT, wi_WideImage::SIDE_LEFT, and wi_WideImage::SIDE_ALL.
		 * You can specify any combination of corners with a + operation, see example below.
		 * 
		 * Example:
		 * <code>
		 * $white = $image->allocateColor(255, 255, 255);
		 * $diagonal_corners = $image->roundCorners(15, $white, 2, wi_WideImage::SIDE_TOP_LEFT + wi_WideImage::SIDE_BOTTOM_RIGHT);
		 * $right_corners = $image->roundCorners(15, $white, 2, wi_WideImage::SIDE_RIGHT);
		 * </code>
		 * 
		 ...
		 * @param int $corners Specify which corners to draw (defaults to wi_WideImage::SIDE_ALL = all corners)
		 * @return wi_WideImage_Image The resulting image with round corners
		 */
		 ...
		 * 
		 * @param wi_WideImage_Image $mask The mask image, greyscale
		 * @param mixed $left Left coordinate, smart coordinate
		 * @param mixed $top Top coordinate, smart coordinate
		 * @return wi_WideImage_Image The resulting image
		 **/
		 ...
		 * @return wi_WideImage_Image The cropped image
		 **/
		 ...
		 *
		 * This operation differs from calling wi_WideImage_Image::applyFilter(IMG_FILTER_NEGATIVE), because it's 8-bit and transparency safe.
		 ...
		 *
		 * @return wi_WideImage_Image negative of the image
		 */
		function asNegative()
		{
		 ...
		 * 
		 * @return wi_WideImage_Image grayscale copy
		 **/
		 ...
		 * 
		 * @return wi_WideImage_Image Mirrored copy
		 **/
		function mirror()
		{
		 ...
		 * @return wi_WideImage_Image Unsharpened copy of the image
		 **/
		 ...
		 * 
		 * @return wi_WideImage_Image Flipped copy
		 **/
		function flip()
		{
		 ...
		 * @return wi_WideImage_Image Image with corrected gamma
		 **/
		 ...
		 * @return wi_WideImage_Image Image with noise added
		 **/
		 ...
		 * 
		 * @return wi_WideImage_Image The copy
		 **/
		function copy()
		{
		 ...
		 * </code>
		 * 
		 * @return wi_WideImage_Canvas The Canvas object
		 **/
		function getCanvas()
		{
			if ($this->canvas == null)
				$this->canvas = new wi_WideImage_Canvas($this);
			return $this->canvas;
		}
		...
		function __wakeup()
		{
			$temp_image = wi_WideImage::loadFromString($this->sdata);
