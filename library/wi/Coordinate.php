 ...
 * @copyright 2007-2011
  ...
  **/
	 ...
	 * @package Exceptions
	 */
	class wi_WideImage_InvalidCoordinateException extends wi_WideImage_Exception {}
	...
	class wi_WideImage_Coordinate
	{
		...
		static function fix($value, $dim, $sec_dim = null)
		{
			...
			if (count($coord_tokens) == 0 || $coord_tokens[count($coord_tokens) - 1]['type'] != 'operand')
				throw new wi_WideImage_InvalidCoordinateException("Couldn't parse coordinate '$value' properly.");
			...
			foreach ($coord_tokens as $token)
			{
				if ($token['type'] == 'operand')
				{
					...
					elseif ($operation == -1)
						...
						throw new wi_WideImage_InvalidCoordinateException("Invalid coordinate syntax.");
