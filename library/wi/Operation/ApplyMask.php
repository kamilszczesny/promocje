 ...
 * @copyright 2007-2011
  ...
  **/
	...
	class wi_WideImage_Operation_ApplyMask
	{
		...
		{
			$left = wi_WideImage_Coordinate::fix($left, $image->getWidth(), $mask->getWidth());
			$top = wi_WideImage_Coordinate::fix($top, $image->getHeight(), $mask->getHeight());
